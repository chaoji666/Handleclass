...
public class TeacherUpdate extends Fragment{
	...
	Button button;
	Context context;
	public TeacherUpdate(Context context)
	{
	...
	public View onCreateView(LayoutInflater inflater,
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int index = test.updateTeacher(editText_sno.getText().toString(),editText_sname.toString(),editText_sex.toString());
				if(index>0)
				{
